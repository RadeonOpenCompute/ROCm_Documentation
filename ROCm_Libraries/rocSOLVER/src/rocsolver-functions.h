...
rocsolver_status rocsolver_slaswp(rocsolver_handle handle, 
...
rocsolver_status rocsolver_dlaswp(rocsolver_handle handle, 
                                                   const rocsolver_int n,
                                                   double *A, 
                                                   const rocsolver_int lda, 
                                                   const rocsolver_int k1, 
...
rocsolver_status rocsolver_claswp(rocsolver_handle handle, 
                                                   const rocsolver_int n,
...
rocsolver_status rocsolver_zlaswp(rocsolver_handle handle, 
                                                   const rocsolver_int n,
...
rocsolver_status rocsolver_slarfg(rocsolver_handle handle, 
                                                 const rocsolver_int n, 
                                                 float *alpha,
                                                 float *x, 
                                                 const rocsolver_int incx, 
...
rocsolver_status rocsolver_dlarfg(rocsolver_handle handle, 
                                                 const rocsolver_int n, 
                                                 double *alpha,
                                                 double *x, 
                                                 const rocsolver_int incx, 
...
rocsolver_status rocsolver_slarft(rocsolver_handle handle,
...
rocsolver_status rocsolver_dlarft(rocsolver_handle handle,
                                                 const rocsolver_direct direct,
                                                 const rocsolver_storev storev, 
                                                 const rocsolver_int n, 
                                                 const rocsolver_int k,
...
rocsolver_status rocsolver_slarf(rocsolver_handle handle, 
...
rocsolver_status rocsolver_dlarf(rocsolver_handle handle, 
                                                const rocsolver_side side, 
                                                const rocsolver_int m,
                                                const rocsolver_int n, 
                                                double* x, 
...
rocsolver_status rocsolver_slarfb(rocsolver_handle handle,
                                                 const rocsolver_side side,
...
rocsolver_status rocsolver_dlarfb(rocsolver_handle handle,
                                                 const rocsolver_side side,
                                                 const rocsolver_operation trans,
                                                 const rocsolver_direct direct, 
                                                 const rocsolver_storev storev, 
...
rocsolver_status rocsolver_sorg2r(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
                                                   float *A,
...
rocsolver_status rocsolver_dorg2r(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
                                                   double *A,
...
rocsolver_status rocsolver_sorgqr(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
                                                   float *A,
...
rocsolver_status rocsolver_dorgqr(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
                                                   double *A,
...
rocsolver_status rocsolver_sorgl2(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
                                                   float *A,
...
rocsolver_status rocsolver_dorgl2(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
                                                   double *A,
...
rocsolver_status rocsolver_sorglq(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
                                                   float *A,
...
rocsolver_status rocsolver_dorglq(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
                                                   double *A,
...
rocsolver_status rocsolver_sorgbr(rocsolver_handle handle,
                                                   const rocsolver_storev storev,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
...
rocsolver_status rocsolver_dorgbr(rocsolver_handle handle,
                                                   const rocsolver_storev storev,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   const rocsolver_int k, 
...
rocsolver_status rocsolver_sorm2r(rocsolver_handle handle,
                                                   const rocsolver_side side,
                                                   const rocsolver_operation trans,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
...
rocsolver_status rocsolver_dorm2r(rocsolver_handle handle,
                                                   const rocsolver_side side,
                                                   const rocsolver_operation trans,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
...
rocsolver_status rocsolver_sormqr(rocsolver_handle handle,
                                                   const rocsolver_side side,
                                                   const rocsolver_operation trans,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
...
rocsolver_status rocsolver_dormqr(rocsolver_handle handle,
                                                   const rocsolver_side side,
                                                   const rocsolver_operation trans,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
...
rocsolver_status rocsolver_sgetf2(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   float *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_dgetf2(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   double *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_cgetf2(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_float_complex *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_zgetf2(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_double_complex *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_sgetf2_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   float *const A[],
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_dgetf2_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   double *const A[],
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_cgetf2_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
...
rocsolver_status rocsolver_zgetf2_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
...
rocsolver_status rocsolver_sgetf2_strided_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   float *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_dgetf2_strided_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   double *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_cgetf2_strided_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_float_complex *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_zgetf2_strided_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_double_complex *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_sgetrf(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   float *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_dgetrf(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   double *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_cgetrf(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_float_complex *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_zgetrf(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_double_complex *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_sgetrf_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   float *const A[],
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_dgetrf_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   double *const A[],
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_cgetrf_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_float_complex *const A[],
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_zgetrf_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_double_complex *const A[],
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_sgetrf_strided_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   float *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_dgetrf_strided_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   double *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_cgetrf_strided_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_float_complex *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_zgetrf_strided_batched(rocsolver_handle handle,
                                                   const rocsolver_int m,
                                                   const rocsolver_int n, 
                                                   rocblas_double_complex *A,
                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_sgeqr2(rocsolver_handle handle, 
                                                 const rocsolver_int m, 
                                                 const rocsolver_int n, 
                                                 float *A,
                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgeqr2(rocsolver_handle handle, 
                                                 const rocsolver_int m, 
                                                 const rocsolver_int n, 
                                                 double *A,
                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgeqr2_batched(rocsolver_handle handle, 
                                                         const rocsolver_int m, 
                                                         const rocsolver_int n, 
                                                         float *const A[],
                                                         const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgeqr2_batched(rocsolver_handle handle, 
                                                         const rocsolver_int m, 
                                                         const rocsolver_int n, 
                                                         double *const A[],
                                                         const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgeqr2_strided_batched(rocsolver_handle handle, 
                                                                 const rocsolver_int m, 
                                                                 const rocsolver_int n, 
                                                                 float *A,
                                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgeqr2_strided_batched(rocsolver_handle handle, 
                                                                 const rocsolver_int m, 
                                                                 const rocsolver_int n, 
                                                                 double *A,
                                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgelq2(rocsolver_handle handle, 
                                                 const rocsolver_int m, 
                                                 const rocsolver_int n, 
                                                 float *A,
                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgelq2(rocsolver_handle handle, 
                                                 const rocsolver_int m, 
                                                 const rocsolver_int n, 
                                                 double *A,
                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgelq2_batched(rocsolver_handle handle, 
                                                         const rocsolver_int m, 
                                                         const rocsolver_int n, 
                                                         float *const A[],
                                                         const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgelq2_batched(rocsolver_handle handle, 
                                                         const rocsolver_int m, 
                                                         const rocsolver_int n, 
                                                         double *const A[],
                                                         const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgelq2_strided_batched(rocsolver_handle handle, 
                                                                 const rocsolver_int m, 
                                                                 const rocsolver_int n, 
                                                                 float *A,
                                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgelq2_strided_batched(rocsolver_handle handle, 
                                                                 const rocsolver_int m, 
                                                                 const rocsolver_int n, 
                                                                 double *A,
                                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgeqrf(rocsolver_handle handle, 
                                                 const rocsolver_int m, 
                                                 const rocsolver_int n, 
                                                 float *A,
                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgeqrf(rocsolver_handle handle, 
                                                 const rocsolver_int m, 
                                                 const rocsolver_int n, 
                                                 double *A,
                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgeqrf_batched(rocsolver_handle handle, 
                                                         const rocsolver_int m, 
                                                         const rocsolver_int n, 
                                                         float *const A[],
                                                         const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgeqrf_batched(rocsolver_handle handle, 
                                                         const rocsolver_int m, 
                                                         const rocsolver_int n, 
                                                         double *const A[],
                                                         const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgeqrf_strided_batched(rocsolver_handle handle, 
                                                                 const rocsolver_int m, 
                                                                 const rocsolver_int n, 
                                                                 float *A,
                                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgeqrf_strided_batched(rocsolver_handle handle, 
                                                                 const rocsolver_int m, 
                                                                 const rocsolver_int n, 
                                                                 double *A,
                                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgelqf(rocsolver_handle handle, 
                                                 const rocsolver_int m, 
                                                 const rocsolver_int n, 
                                                 float *A,
                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgelqf(rocsolver_handle handle, 
                                                 const rocsolver_int m, 
                                                 const rocsolver_int n, 
                                                 double *A,
                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgelqf_batched(rocsolver_handle handle, 
                                                         const rocsolver_int m, 
                                                         const rocsolver_int n, 
                                                         float *const A[],
                                                         const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgelqf_batched(rocsolver_handle handle, 
                                                         const rocsolver_int m, 
                                                         const rocsolver_int n, 
                                                         double *const A[],
                                                         const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgelqf_strided_batched(rocsolver_handle handle, 
                                                                 const rocsolver_int m, 
                                                                 const rocsolver_int n, 
                                                                 float *A,
                                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_dgelqf_strided_batched(rocsolver_handle handle, 
                                                                 const rocsolver_int m, 
                                                                 const rocsolver_int n, 
                                                                 double *A,
                                                                 const rocsolver_int lda, 
...
rocsolver_status rocsolver_sgetrs(
...
rocsolver_status rocsolver_dgetrs(
    rocsolver_handle handle, const rocsolver_operation trans, const rocsolver_int n,
...
rocsolver_status rocsolver_zgetrs(
    rocsolver_handle handle, const rocsolver_operation trans, const rocsolver_int n,
...
rocsolver_status rocsolver_sgetrs_batched(
...
rocsolver_status rocsolver_dgetrs_batched(
                 rocblas_handle handle, const rocblas_operation trans, const rocblas_int n,
...
rocsolver_status rocsolver_cgetrs_batched(
                 rocblas_handle handle, const rocblas_operation trans, const rocblas_int n,
...
rocsolver_status rocsolver_zgetrs_batched(
                 rocblas_handle handle, const rocblas_operation trans, const rocblas_int n,
...
rocsolver_status rocsolver_sgetrs_strided_batched(
                 rocblas_handle handle, const rocblas_operation trans, const rocblas_int n,
...
rocsolver_status rocsolver_dgetrs_strided_batched(
                 rocblas_handle handle, const rocblas_operation trans, const rocblas_int n,
...
rocsolver_status rocsolver_zgetrs_strided_batched(
                 rocblas_handle handle, const rocblas_operation trans, const rocblas_int n,
...
rocsolver_status rocsolver_spotf2(rocsolver_handle handle,
                                                   const rocsolver_fill uplo,
                                                   const rocsolver_int n, float *A,
                                                   const rocsolver_int lda,
                                                   rocblas_int* info);

rocsolver_status rocsolver_dpotf2(rocsolver_handle handle,
                                                   const rocsolver_fill uplo,
...
rocsolver_status rocsolver_spotf2_batched(rocsolver_handle handle,
                                                           const rocsolver_fill uplo,
                                                           const rocsolver_int n, 
                                                           float *const A[],
                                                           const rocsolver_int lda,
...
rocsolver_status rocsolver_dpotf2_batched(rocsolver_handle handle,
                                                           const rocsolver_fill uplo,
                                                           const rocsolver_int n, 
                                                           double *const A[],
                                                           const rocsolver_int lda,
...
rocsolver_status rocsolver_spotf2_strided_batched(rocsolver_handle handle,
                                                                   const rocsolver_fill uplo,
                                                                   const rocsolver_int n, 
                                                                   float *A,
                                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_dpotf2_strided_batched(rocsolver_handle handle,
                                                                   const rocsolver_fill uplo,
                                                                   const rocsolver_int n, 
                                                                   double *A,
                                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_spotrf(rocsolver_handle handle,
                                                   const rocsolver_fill uplo,
                                                   const rocsolver_int n, float *A,
                                                   const rocsolver_int lda,
                                                   rocblas_int* info);

rocsolver_status rocsolver_dpotrf(rocsolver_handle handle,
                                                   const rocsolver_fill uplo,
                                                   const rocsolver_int n, double *A,
                                                   const rocsolver_int lda,
                                                   rocblas_int* info);
...
rocsolver_status rocsolver_spotrf_batched(rocsolver_handle handle,
                                                           const rocsolver_fill uplo,
                                                           const rocsolver_int n, 
                                                           float *const A[],
                                                           const rocsolver_int lda,
...
rocsolver_status rocsolver_dpotrf_batched(rocsolver_handle handle,
                                                           const rocsolver_fill uplo,
                                                           const rocsolver_int n, 
                                                           double *const A[],
                                                           const rocsolver_int lda,
...
rocsolver_status rocsolver_spotrf_strided_batched(rocsolver_handle handle,
                                                                   const rocsolver_fill uplo,
                                                                   const rocsolver_int n, 
                                                                   float *A,
                                                                   const rocsolver_int lda,
...
rocsolver_status rocsolver_dpotrf_strided_batched(rocsolver_handle handle,
                                                                   const rocsolver_fill uplo,
                                                                   const rocsolver_int n, 
                                                                   double *A,
                                                                   const rocsolver_int lda,
