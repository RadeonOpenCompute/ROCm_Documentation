 ...
 * `HTML Documentation (generated with Doxygen) <http://clmathlibraries.github.io/clRNG/htmldocs/index.html>`_
 * `Tutorial Document (please cite this document if you use clRNG) clRNG: A Random Number API with Multiple Streams for OpenCL <http://clmathlibraries.github.io/clRNG/docs/clrng-api.pdf>`_
