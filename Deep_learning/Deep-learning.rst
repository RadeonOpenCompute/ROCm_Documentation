...
First, you’ll need to install the open-source ROCm 2.10 stack. Details can be found `here <https://github.com/RadeonOpenCompute/ROCm>`_
...
The ROCm 2.10 has prebuilt packages for MIOpen
***********************************************
...
A ROCm install version 2.10 is required currently.
